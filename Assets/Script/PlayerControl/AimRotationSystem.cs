...
public class AimRotationSystem : MonoBehaviour
{

    [SerializeField] private GameObject playerSprite; //캐릭터 스프라이트
    [SerializeField] private GameObject weaponPivot;  //무기 스프라이트
    ...
    private void RotateArm(Vector2 aimDirection)
    {
        ...
        weaponPivot.transform.rotation = Quaternion.Euler(0, 0, rotZ);// Euler값으로 변환 ==우리가 2D사용이기 때문에 ## 중요
    }
}
